...
# Read as Shapefile -------------------------------------------------------
amostras <- raster::shapefile("Documents/lulc_ml_methods_course/exercices/data/samples_final.shp")
...
in_raster <- stack("Documents/lulc_ml_methods_course/exercices/data/mosaic.tif")
...
writeRaster(pred_raster, "Documents/lulc_ml_methods_course/exercices/data/output_class.tif") # Save the output raster as .tif